...
ShowOverlay() {
    ...
    OverlayGui.Add("Text",, "═══════════════════════════════════════")
    OverlayGui.Add("Text",, "  Numpad1  → Чистка ПМ")
    OverlayGui.Add("Text",, "  Numpad2  → Представление")
    OverlayGui.Add("Text",, "  Numpad3  → Ксива")
    OverlayGui.Add("Text",, "  Numpad4  → Наручники / Обыск")
    OverlayGui.Add("Text",, "  Numpad5  → Рация")
    OverlayGui.Add("Text",, "  Numpad6  → Миранда")
    OverlayGui.Add("Text",, "  Numpad7  → Вести к машине / ИВС")
    OverlayGui.Add("Text",, "  Numpad8  → ПМ в боевое")
    OverlayGui.Add("Text",, "  Numpad9  → Мегафон")
    OverlayGui.Add("Text",, "  Numpad0  → Штраф")
    OverlayGui.Add("Text",, "  Ctrl+Numpad1  → Вытаскивание из машины")
    OverlayGui.Add("Text",, "  Ctrl+Numpad2  → Оформление ДТП")
    OverlayGui.Add("Text",, "═══════════════════════════════════════")
...
F2::
{
    ...
    Send("{Backspace}")
    PauseWithCheck(300)
    SendText("-Здравия желаю, " Data.Department " ОМВД России по провинциальному району, " Data.Rank " " Data.LastName " (da da da da da da)")
    Send("{Enter}")
    PauseWithCheck(300)
