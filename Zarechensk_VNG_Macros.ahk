...
ShowOverlay() {
    ...
    OverlayGui.Title := "ВНГ макрос"
    
    OverlayGui.Add("Text",, "═══════════════════════════════════════")
    OverlayGui.SetFont("s10 w600", "Montserrat SemiBold")
    OverlayGui.Add("Text",, "  ГОРЯЧИЕ КЛАВИШИ ВНГ")
    OverlayGui.SetFont("s9 w400", "Montserrat")
    OverlayGui.Add("Text",, "═══════════════════════════════════════")
...
F2:: {
    ...
    SendToDiscord("⚡ ВНГ: Представление")
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("-Здравия желаю, " Data.Department " , " Data.Rank " " Data.LastName " (da da da da da da) " )
    Send("{Enter}")
    PauseWithCheck(300)
...
F4:: {
    ...
    SendToDiscord("⚡ ВНГ: Наручники/Обыск")
...
F9:: {
    ...
    SendToDiscord("⚡ ВНГ: Вытаскивание из машины")
...
F10:: {
    ...
    SendToDiscord("⚡ ВНГ: Получение Дозора")
...
^F1:: {
    ...
    SendToDiscord("⚡ ВНГ: Включение записи")
...
^F2:: {
    ...
    SendToDiscord("⚡ ВНГ: Проверка заряда")
...
^F3:: {
    ...
    SendToDiscord("⚡ ВНГ: Технический сбой")
...
^F4:: {
    ...
    SendToDiscord("⚡ ВНГ: Окончание записи")
...
^F5:: {
    ...
    SendToDiscord("⚡ ВНГ: Сдача Дозора")
