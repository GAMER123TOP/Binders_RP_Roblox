...
ShowOverlay() {
    ...
    OverlayGui.Add("Text",, "  Ctrl+Numpad1 / Ctrl+F1 → ТТ-33 из кобуры")
    OverlayGui.Add("Text",, "  Ctrl+Numpad2 / Ctrl+F2 → ТТ-33 в кобуру")
    OverlayGui.Add("Text",, "  Ctrl+Numpad3 / Ctrl+F3 → АС `"Вал`" на грудь")
    OverlayGui.Add("Text",, "═══════════════════════════════════════")
...
F1::
{
    ...
    SendToDiscord("⚡ ФСБ: Представление")
...
F2:: {
    ...
    SendToDiscord("⚡ ФСБ: Удостоверение")
...
F3::
{
    ...
    SendToDiscord("⚡ ФСБ: Наручники/Обыск")
...
F7::
{
    ...
    SendToDiscord("⚡ ФСБ: ТТ-33 в боевое")
...
F9::
{
    ...
    SendToDiscord("⚡ ФСБ: АС Вал в боевое")
    ToolTip("АС Вал...")
    SetTimer(() => ToolTip(), -1500)
...
F10::
{
    ...
    SendToDiscord("⚡ ФСБ: Вытаскивание из машины")
...
; ===== 11. ТТ-33 ИЗ КОБУРЫ (Ctrl+Numpad1) =====
^Numpad1::
^F1:: {
    global StopMacro
    if StopMacro {
    ...
    SendToDiscord("⚡ ФСБ: ТТ-33 из кобуры")
    ToolTip("ТТ-33 из кобуры...")
    SetTimer(() => ToolTip(), -1500)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/do ТТ-33 не в боевом положении")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/me снял ТТ-33 с предохранителя")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/do ТТ-33 в боевом положении")
    Send("{Enter}")
    PauseWithCheck(300)
...
; ===== 12. ТТ-33 В КОБУРУ (Ctrl+Numpad2) =====
^Numpad2::
^F2:: {
    global StopMacro
    if StopMacro {
    ...
    SendToDiscord("⚡ ФСБ: ТТ-33 в кобуру")
    ToolTip("ТТ-33 в кобуру...")
    SetTimer(() => ToolTip(), -1500)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/me поставил ТТ-33 на предохранитель")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/do ТТ-33 на предохранителе")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/me убрал ТТ-33 в кобуру")
    Send("{Enter}")
    PauseWithCheck(300)
...
; ===== 13. АС ВАЛ ИЗ БОЕВОГО (Ctrl+Numpad3) =====
^Numpad3::
^F3:: {
    global StopMacro
    if StopMacro {
    ...
    SendToDiscord("⚡ ФСБ: АС ВАЛ из боевого")
    ToolTip("АС ВАЛ из боевого...")
    SetTimer(() => ToolTip(), -1500)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/me поставил АС ВАЛ на предохранитель")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/do АС ВАЛ на предохранителе")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/do АС ВАЛ не в боевом положении")
    Send("{Enter}")
    PauseWithCheck(300)
    ...
    Send("{. up}")
    PauseWithCheck(300)
    SendText("/me повесил АС ВАЛ на грудь")
    Send("{Enter}")
    PauseWithCheck(300)
